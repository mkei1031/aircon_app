...
temp_max = st.number_input("9時〜19時の最高気温（℃）", min_value=-10.0, max_value=50.0, step=0.1)
temp_min = st.number_input("9時〜19時の最低気温（℃）", min_value=-10.0, max_value=50.0, step=0.1)
